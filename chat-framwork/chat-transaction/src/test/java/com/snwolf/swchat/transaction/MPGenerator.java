package com.snwolf.swchat.transaction;
...
public class MPGenerator {
    public static void main(String[] args) {
        ...
        //todo 要改输出路径
        globalConfig.setOutputDir(System.getProperty("user.dir") + "/chat-framwork/chat-transaction/src/main/java");
        //设置作者名字
        globalConfig.setAuthor("<a href=\"https://github.com/SnowWolf68\">SnowWolf68</a>");
        ...
        packageConfig.setParent("com.snwolf.swchat.transaction");//自定义包的路径
...
//        strategyConfig.setTableFillList(list);
    ...
    public static void assembleDev(DataSourceConfig dataSourceConfig) {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://127.0.0.1:3306/sw-chat?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=UTC");
    }
}